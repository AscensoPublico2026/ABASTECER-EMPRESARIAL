...
export default function ClientesPage() {
  return (
    <div>
      <Header title="Clientes" subtitle="Directorio de clientes" />
      <div className="p-8">
        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-sm text-gray-500 text-center max-w-md">Aqui podras gestionar tu base de clientes, sus datos de contacto y el historial de compras.</p>
        </div>
      </div>
    </div>
  )
